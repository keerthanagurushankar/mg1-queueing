...
def run_2Class_MG1_tests(test_label, l1, l2, S1, S2, policy):
    ...
    T = theoretical_MG1.T(policy.policy_name)
    if T is None:
        print(test_label + " T1", empirical_ET1, empirical_VarT1)
        print(test_label + " T2", empirical_ET2, empirical_VarT2)
        return 
...
if __name__ == "__main__":
    ...
    run_2Class_MG1_tests("2cMM1acc100", l1, l2, lib.exp(mu1), lib.exp(mu2), NPAccPrio)
    run_2Class_MG1_tests("2cMD1acc100", l1, l2, lib.det(mu1), lib.det(mu2), NPAccPrio)
    run_2Class_MG1_tests("2cMH1acc100", l1, l2, lib.hyperexponential(mu1, Csq=5),
